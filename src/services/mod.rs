...
pub use self::product_service::{create_product, deposit, transfer, approve_product, generate_account_number};
pub use self::email_service::{send_template_email};
pub use self::customer_service::{create_customer_with_product};