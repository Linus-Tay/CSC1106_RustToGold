...
pub use self::admin_controller::{
    ...
    admin_customer_accounts_page, admin_dashboard, admin_personal_loans_page, admin_signups_page,
    admin_staff_page, approve_customer_application, approve_personal_loan, close_customer_product,
