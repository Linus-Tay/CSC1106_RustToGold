...
pub use self::customer_controller::{
    dashboard, deposit, deposit_page, profile_page, transactions,
...
pub use self::home_loan_controller::{
   admin_home_loans_page, approve_home_loan, create_home_loan_application,
   home_loan_apply_page, home_loans_page, pay_home_loan, reject_home_loan
};
